...
module axi_ad4857 #(
  ...
  // Fixed for AD4857 only
  localparam             RESOLUTION = 16;

  // AD4857 has 8 channels
  ...
  generate
    ...
    for (i = 0; i < 8; i=i+1) begin : channel
      if (i < N_CHANNELS) begin // LVDS
        ...
        // AD4857: use 16-bit channel implementation
        axi_ad4857_16b_channel #(
          .CHANNEL_ID(i),
          .ACTIVE_LANE (ACTIVE_LANES)
        ) i_adc_channel (
          .adc_clk (adc_clk_s),
