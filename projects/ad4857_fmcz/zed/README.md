...
- DEVICE - selects the device to be used (AD4857 only):
  - AD4857 (default)
...
The project is fixed to build for `AD4857` only; no other parts are supported.
