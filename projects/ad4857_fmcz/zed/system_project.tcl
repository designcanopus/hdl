...
# Hardcoded for AD4857 only
set DEVICE "AD4857"
set env(DEVICE) $DEVICE

adi_project ad4857_fmcz_zed 0 [list \
...
adi_project_files {} [list \
  ...
  "../common/Event_Capture_Accumulator.v" \
  "../common/Event_Capture_AXIL.v" \
  "../common/Event_Capture_Buffer.v" \
  "../common/Event_Capture_Detector.v" \
  "../common/Event_Capture_FSM.v" \
  "../common/Event_Capture.v" \
]

adi_project_run ad4857_fmcz_zed
